...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    console.log('Reset password - parâmetros da URL:', { accessToken: !!accessToken, refreshToken: !!refreshToken, type });
    ...
    if (accessToken && refreshToken && type === 'recovery') {
      ...
      console.error('Parâmetros faltando na URL:', { accessToken: !!accessToken, refreshToken: !!refreshToken, type });
      toast.error('Link inválido ou expirado');
      navigate('/');
    }
