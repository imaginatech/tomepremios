              ...
              <Card key={result.id} className="overflow-hidden hover:shadow-lg transition-shadow border-primary/20">
                ...
                <div className="p-6">
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-6 gap-x-1 gap-y-0.5 justify-items-center">
                      {result.drawn_numbers.map((num, i) => (
                        <div key={i} className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 text-white font-bold text-xs flex items-center justify-center shadow-sm">
